# Thin .NET 6/8 console app/dotnet tool around IKVM cross-compiled .NET version of Saxon-HE 11.6 Java
...
Install with e.g. 
```
dotnet tool install --global SaxonHE11NetXslt --version 11.6.8.9
```
